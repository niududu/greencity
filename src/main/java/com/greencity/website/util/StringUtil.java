...
public final class StringUtil {
  ...
  //随机返回字符串数组中的字符串
    ...
    */
    ...
    /**
     * @MethodName: getKeysByLoop
     * @Description: 在Map中通过VALUE获取Key
     * @Param: [map, value]
     * @Return: java.lang.Integer
     * @Author: LiuZW
     * @Date: 2020/4/21 18:56
     **/
    public static Integer getKeysByLoop(Map<Integer, String> map, String value) {
